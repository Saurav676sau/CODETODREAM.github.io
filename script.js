let canvas = document.getElementById('stage');
  ...
  if(value=="kamini"){
    console.log("User entered kamini");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://i.ibb.co/HhQGQXX/DSC-0782.jpg`;
    const hoverUrl = "https://i.ibb.co/HhQGQXX/DSC-0782.jpg";
  ...
  if(value=="Komal"){
    ...
    console.log("User entered Komal");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://i.ibb.co/p39MsQ5/DSC-1098.jpg`;
    const hoverUrl = "https://i.ibb.co/p39MsQ5/DSC-1098.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="Saurav"){
    console.log("User entered Saurav");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://i.ibb.co/QYs4YDh/1.jpg`;
    const hoverUrl = "https://i.ibb.co/QYs4YDh/1.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
